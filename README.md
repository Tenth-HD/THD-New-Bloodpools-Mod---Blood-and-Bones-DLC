...
This mod edits the regular and prismatic bloodpool textures to:
     ...
     * Ensuring the ingame reflections work with new textures
    
New Changes: Added 8 new red bloodpools. Added 10 prismatic bloodpools to all colors except rainbow and white. Also changed the blood colors for the Argus and Scarabs to match their ingame vfx.

Currently Unknown - How to replace blood damage overlays to match blood colors.
...
v 1.1
     ...
     * Added 4 edited blood pools from WankingSkeever's mod
     * Changed the following myth unit blood colors: Scarab (Purple), Argus (Green)
